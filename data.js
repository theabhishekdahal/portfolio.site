const portfolioData = {
    ...
    experience: [
        ...
        },
        {
            ...
            skills: ["Adobe InDesign", "Graphic Design", "Adobe Photoshop", "Print Production"]
        }
    ],
    skills: [
        { name: "Mircrosoft Excel" }, { name: "Mircrosoft Word" }, { name: "Mircrosoft PowerPoint" },
        { name: "Busy" }, { name: "Adobe InDesign" }, { name: "QuickBooks" },
        { name: "Tally Prime" }, { name: "Adobe Photoshop" }, { name: "Power BI" },
    ...
    education: [
        ...
        },
        {
            ...
            duties: "<strong>Activities :</strong> Led the revival of the school's discontinued yearbook, 'Jharana,' overseeing all aspects from design and content collection to final production. Also designed and developed the official school website using WordPress, enhancing skills in project management, graphic design, and web development."
        }
    ],
    awards: [
        {
